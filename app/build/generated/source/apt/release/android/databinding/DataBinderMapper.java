...
class DataBinderMapper  {
    ...
    public android.databinding.ViewDataBinding getDataBinder(android.databinding.DataBindingComponent bindingComponent, android.view.View view, int layoutId) {
        switch(layoutId) {
                ...
                case com.andrewtakao.alight.R.layout.activity_tour:
                    return com.andrewtakao.alight.databinding.ActivityTourBinding.bind(view, bindingComponent);
                case com.andrewtakao.alight.R.layout.activity_fourty_seven_tour:
                    return com.andrewtakao.alight.databinding.ActivityFourtySevenTourBinding.bind(view, bindingComponent);
    ...
    int getLayoutId(String tag) {
        ...
        switch(code) {
            ...
            case 637447764: {
                if(tag.equals("layout/activity_tour_0")) {
                    return com.andrewtakao.alight.R.layout.activity_tour;
                }
                break;
            }
            case 1232520612: {
                if(tag.equals("layout/activity_fourty_seven_tour_0")) {
                    return com.andrewtakao.alight.R.layout.activity_fourty_seven_tour;
                }
                break;
            }
            case -1762045082: {
